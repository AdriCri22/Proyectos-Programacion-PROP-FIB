...
/**
 * Representa un diàleg que demana informació per afegir files en un full del document.
 *
 * @author carla.canovas.iglesias
 */
public class AddRowsDialogView extends JDialog {
    ...
    /**
     * Representa el camp de text on l'usuari escriu la fila inicial des d'on volem afegir.
     */
    private JTextField inputInitialRow;

    /**
     * Representa el camp de text on l'usuari escriu el nombre de files a afegir.
     */
     ...
     */
    public AddRowsDialogView() {
        setContentPane(contentPane);
        setModal(true);
        setSize(800, 400);

        buttonOK.addActionListener(e -> {
            if (!inputInitialRow.getText().isEmpty() && !inputRowsNum.getText().isEmpty()) setVisible(false);
        });
        buttonCancel.addActionListener(e -> setVisible(false));
    }

    /**
     * Obté la fila inicial des d'on afegir.
     */
    ...
    /**
     * Obté el nombre de files a afegir.
     */
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label2.setText("Indica la fila inicial des d'on vols afegir-ne noves");
        ...
        label3.setText("Indica el nombre de files a afegir");
