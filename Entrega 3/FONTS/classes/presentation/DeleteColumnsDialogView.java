...
/**
 * Representa un diàleg que demana informació per eliminar columnes en un full del document.
 *
 * @author carla.canovas.iglesias
 */
public class DeleteColumnsDialogView extends JDialog {
    ...
    /**
     * Representa el camp de text on l'usuari escriu la columna inicial des d'on volem eliminar.
     */
    private JTextField inputInitialCol;

    /**
     * Representa el camp de text on l'usuari escriu el nombre de columnes a eliminar.
     */
    private JTextField inputColsNum;

    /**
     * Constructora del diàleg.
     */
    public DeleteColumnsDialogView() {
        setContentPane(contentPane);
        setModal(true);
        setSize(800, 400);

        buttonOK.addActionListener(e -> {
            if (!inputColsNum.getText().isEmpty() && !inputInitialCol.getText().isEmpty()) setVisible(false);
        });
        buttonCancel.addActionListener(e -> setVisible(false));
    }

    /**
     * Obté la columna inicial des d'on eliminar.
     */
    public String getIniCol() {
        return inputInitialCol.getText();
    }

    /**
     * Obté el nombre de columnes a eliminar.
     */
    public String getNumCols() {
        return inputColsNum.getText();
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText("ELIMINAR COLUMNES");
        ...
        label2.setText("Indica la columna inicial des d'on vols eliminar les columnes");
        ...
        inputInitialCol = new JTextField();
        inputInitialCol.setBackground(new Color(-3090225));
        inputInitialCol.setText("");
        panel4.add(inputInitialCol, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        inputColsNum = new JTextField();
        inputColsNum.setBackground(new Color(-3090225));
        inputColsNum.setText("");
        panel4.add(inputColsNum, new GridConstraints(3, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        ...
        label3.setText("Indica el nombre de columnes a eliminar");
